...
<!-- SlimScroll -->
<script src="{{ asset('/') }}admin-panel/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="{{ asset('/') }}admin-panel/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="{{ asset('/') }}admin-panel/dist/js/app.min.js"></script>
